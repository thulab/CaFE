const enUS = {
  ...
  results: {
    ...
    forecastAriaOne: 'Forecast chart with {history} history steps, {truth} ground-truth steps and {models} model forecast.',
    forecastAriaOther: 'Forecast chart with {history} history steps, {truth} ground-truth steps and {models} model forecasts.',
