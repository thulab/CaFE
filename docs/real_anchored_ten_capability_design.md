# CaFE v11：基于真实基准路径的十项能力公式设计

本文从原始数据开始，完整说明 CaFE v11 如何在 GIFT-Eval 官方测试实例上构造十项能力评测。读者只按本文顺序阅读，就能知道每个量是什么、来自哪里、如何计算，哪些值来自数据采集，哪些值由程序推导，哪些值是人工配置，以及最终怎样得到 treatment 的历史与未来。
