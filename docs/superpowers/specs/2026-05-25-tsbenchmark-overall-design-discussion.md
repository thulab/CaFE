...
- 2026-05-25：细化为执行计划 [`../done/2026-05-25-tsbenchmark-overall-design-implementation-plan.md`](../done/2026-05-25-tsbenchmark-overall-design-implementation-plan.md)（Track A 基线脚本化 + Track B 7 层 TDD 任务）。锁定三项决策：本轮文档先行待评审、forecast 输出维持 JSONL（§6 #1）、切 MASE 主排名（§6 #5）。
