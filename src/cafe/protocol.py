...
DATASET_REGISTRY = {
    ...
    for spec in (
        ...
        DatasetSpec(
            ...
            "m5_1D",
            "Business",
            task_view_id="store_category_department_children",
            real_data_adapter="fev_parquet",
        ),
        DatasetSpec(
            "fev_favorita_stores_1d_hierarchy",
            "FEV Favorita Store Sales Hierarchy",
            "fev/favorita_stores_1D/hierarchy",
            "favorita_stores_1D",
            "Business",
            task_view_id="store_family_sibling_pairs",
            real_data_adapter="fev_parquet",
        ),
        DatasetSpec(
            "fev_favorita_transactions_1d_hierarchy",
            "FEV Favorita Transactions Hierarchy",
            "fev/favorita_transactions_1D/hierarchy",
            "favorita_transactions_1D",
            "Business",
            task_view_id="city_store_sibling_pairs",
            real_data_adapter="fev_parquet",
        ),
        DatasetSpec(
            "m5_daily",
