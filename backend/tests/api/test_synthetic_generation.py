...
def test_synthetic_capabilities_and_generation_materialize_shards(app, client):
    ...
    assert trend_capability["generator_version"] == "capts-paper-v4"
    ...
    with Session(app.state.engine) as session:
        ...
        assert covariate.generation_config["generator_version"] == "capts-paper-v4"
        ...
        assert trend_metadata["generator_version"] == "capts-paper-v4"
        ...
        assert trend_metadata["latent_params"]["generator_version"] == "capts-paper-v4"
